...
![4884785](https://github.com/tac-consulting/tac-frontend-roadmap/assets/56499420/f76f7ad8-4257-4019-8305-cb7749776aaf)
...
- [What is Web?](#what-is-web)
  - [Web in Our Words](#web-in-our-words)
- [Classification of Web Development](#classification-of-web-development)
  - [Frontend Web](#frontend-web)
- [Roadmap for Frontend Development](#roadmap-for-frontend-development)
  - [HTML](#html)
    - [Resources](#resources)
  - [CSS](#css)
  ...
  - [ReactJS](#reactjs)
    ...
    - [Topics to Be Learnt](#topics-to-be-learnt)
...
Read more at [![portfolio](https://www.techopedia.com/wp-content/uploads/2023/08/techopedia-light.svg)](https://katherineoelsner.com/)

## Web in our words..
Simply what I can say is, without web there is no use of internet in most of cases 😅
...
This is not a programming language and easy to learn. HTML does not require any logical things and I would say only HTML is the language which produce no errors 🤣
...
- Websites to learn HTML
    ...
    - [freecodecamp.com](https://www.freecodecamp.org/news/html-crash-course/)

- Video Tutorials
    - [HTML - Programming with mosh](https://youtu.be/qz0aGYrrlhU?si=G38IW4mZvjxgIy-Q)
    - [HTML - Apna College](https://youtu.be/HcOc7P5BMi4?si=smfRjdEcDAwV30qq)
...
Learn more what is CSS at [mdn docs](https://developer.mozilla.org/en-US/docs/Learn/CSS/First_steps/What_is_CSS)
...
- Video Tutorials
    - [CSS - Bro Code](https://youtu.be/wRNinF7YQqQ?si=ppn9jAY9DZCr48zo)
    - [CSS - freecodecamp](https://youtu.be/ieTHC78giGQ?si=UWJlAfSvhbQ-dR85)
    - [Complete CSS - Apna College](https://youtu.be/ESnrn1kAD4E?si=9PqhPg9B9OrgSqsx)
...
- Video Tutorials
    - [JavaScript Dom Manipulation](https://youtu.be/5fb2aPlgoys?si=ym6gRrgku5c2-sDb) - freecodecamp
...
## ReactJS <sup>V18.0.0</sup>
Official Site: [React](https://react.dev/)
...
We have lot of [npm dependencies](https://www.npmjs.com/) which are used in ReactJS to reduce our work. 
...
- Websites to learn ReactJS
    ...
    - [mdn docs- get started with react](https://developer.mozilla.org/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/React_getting_started)

- Video Tutorials
    - [React Playlist](https://www.youtube.com/playlist?list=PLC3y8-rFHvwgg3vaYJgHGnModB54rxOk3)- Codevolution
    - [React in 1Hr ](https://youtu.be/Ke90Tje7VS0?si=kl3aX7r-6m5LL8Mm)- Mosh
    - [ReatcJS ](https://www.youtube.com/live/9vZ8ELqerPo?si=mib1Xy5ME3khehAK)- Intellipaat


    - [React - The Complete Guide 2023 (incl. React Router & Redux)](https://www.udemy.com/course/react-the-complete-guide-incl-redux/) - Udemy
...
- HTML & CSS - [Amazon Clone: Apna College](https://youtu.be/nGhKIC_7Mkk?si=PGQq8zhWqwUpcHnM)
- HTML, CSS & JS - [Responsive Portfolio](https://youtu.be/XRSQHkzrQGQ?si=bLeVuBdJQTwP8Eho)
- HTML, CSS & JS - [Spotify Clone](https://youtu.be/OafpiyPa63I?si=6OEM257OnNCXFlsH)
- ReactJS - [E-Commerce App](https://www.youtube.com/watch?v=jbfuzcrfjqQ)
- ReactJS - [Phonebook App](https://youtu.be/QoJGKwo20is?si=51YKSRSKj4FpUb9R)
- ReactJS - [Travel Website - Responsive](https://www.youtube.com/watch?v=I2UBjN5ER4s)

__NOTE:__ My suggesstion is don't choose Ed-tech platforms just to learn skills, we have lot of content for free on internet. If necessary, go with Udemy. It provide good content at low prices
...
Exlore about us at [techatcore.com](https://techatcore.com/)
